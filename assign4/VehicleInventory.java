...
*	Holds the VehicleInventory LinkedList and does appropriate functions.
*/
...
public class VehicleInventory implements Serializable {
    ...
    public Set<Vehicle> searchInventory(int vehType, String make, String model,
        ...
        } catch (NumberFormatException ex) { //string to number
            throw new BadInputException("NumberFormatException");
        }
        
        //Simulates a loading/working server
        try {
     ...
     /**
     * Verify if a Vehicle matches the proposed type
     * @param vehType
     * @param Vehicle:v
     * @return Boolean
     */
